...
// configure
$from = 'ahmadhassan9059@gmail.com'; // Replace it with Your Hosting Admin email. REQUIRED!
$sendTo = 'ahmadhassan9059@gmail.com'; // Replace it with Your email. REQUIRED!
...
if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    ...
    $c = curl_init('https://www.google.com/recaptcha/api/siteverify?secret=6LdqmCAUAAAAANONcPUkgVpTSGGqm60cabVMVaON'.$secret.'&response='.$_POST['g-recaptcha-response']);
